...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=625707687ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_booking&table=users">`bus_booking`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_booking&table=appointment_requests">`bus_booking`.`appointment_requests`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_booking&table=appointments">`bus_booking`.`appointments`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7e684b366e7336246346542c2a2b4365">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="bus_booking" targettable="appointment_requests">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointment_requests`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bus_booking" targettable="appointment_requests">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointment_requests`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bus_booking" targettable="appointments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointments`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bus_booking" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
